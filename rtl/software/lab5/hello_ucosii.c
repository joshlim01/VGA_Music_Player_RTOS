...
unsigned int current_song_size;

extern unsigned char song_1[];
extern unsigned int size_song_1;

extern unsigned char song_2[];
extern unsigned int size_song_2;

extern unsigned char song_3[];
extern unsigned int size_song_3;
...
void init_background() { // INIT BACKGROUND
	...
	draw_button(667, 252, 120, 35, 0xCC6600, "ASK", 1, SW_Frame);
	draw_button(667, 289, 120, 35, 0xCC6600, "FSK", 0, SW_Frame);
	draw_button(667, 326, 120, 35, 0xCC6600, "BPSK", 0, SW_Frame);
	draw_button(667, 365, 120, 35, 0xCC6600, "LFSR", 0, SW_Frame);
	...
	draw_button(667, 10, 50, 35, 0xCC6600, "R", 1, SW_Frame);	// bonus
	draw_button(727, 10, 50, 35, 0xCC6600, "W", 0, SW_Frame);	// bonus
	draw_button(667, 50, 50, 35, 0xCC6600, "B", 0, SW_Frame);	// bonus
	draw_button(727, 50, 50, 35, 0xCC6600, "Y", 0, SW_Frame);	// bonus

	draw_button(667,  91, 120, 35, 0xCC6600, "PREV", 0, SW_Frame); // bonus
	draw_button(667,  128, 120, 35, 0xCC6600, "NEXT", 0, SW_Frame); // bonus
	draw_button(667,  165, 120, 35, 0xCC6600, "QPSK", 0, SW_Frame); // bonus
...
;
audio_dac_wr_fifo( buf[i % current_song_size]);
}
...
if (play_song == 1) {
	...
	send_audio_fifo(&current_song[address_counter % current_song_size]);
	if (address_counter < current_song_size) {
...
if (event == 1) {	//down event
	...
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 252
		...
		select_modulation(0);
			...
			&& y_mouse <= (289 + 35)) {
		draw_button(667, 252, 120, 35, 0xCC6600, "ASK", 0, SW_Frame);
		draw_button(667, 289, 120, 35, 0xCC6600, "FSK", 1, SW_Frame);
		draw_button(667, 326, 120, 35, 0xCC6600, "BPSK", 0, SW_Frame);
		draw_button(667, 365, 120, 35, 0xCC6600, "LFSR", 0, SW_Frame);
		draw_button(667, 165, 120, 35, 0xCC6600, "QPSK", 0, SW_Frame); // bonus
		...
		draw_button(667, 252, 120, 35, 0xCC6600, "ASK", 0, SW_Frame);
		draw_button(667, 289, 120, 35, 0xCC6600, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0xCC6600, "BPSK", 1, SW_Frame);
		draw_button(667, 365, 120, 35, 0xCC6600, "LFSR", 0, SW_Frame);
		draw_button(667, 165, 120, 35, 0xCC6600, "QPSK", 0, SW_Frame); // bonus
		...
		draw_button(667, 289, 120, 35, 0xCC6600, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0xCC6600, "BPSK", 0, SW_Frame);
		draw_button(667, 365, 120, 35, 0xCC6600, "LFSR", 1, SW_Frame);
		draw_button(667, 165, 120, 35, 0xCC6600, "QPSK", 0, SW_Frame); // bonus

		select_modulation(3);
	} else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 165
			&& y_mouse <= (165 + 35)) {
		draw_button(667, 252, 120, 35, 0xCC6600, "ASK", 0, SW_Frame);
		draw_button(667, 289, 120, 35, 0xCC6600, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0xCC6600, "BPSK", 0, SW_Frame);
		draw_button(667, 365, 120, 35, 0xCC6600, "LFSR", 0, SW_Frame);
		draw_button(667, 165, 120, 35, 0xCC6600, "QPSK", 1, SW_Frame); // bonus
	...
	//BONUS: Logic for the color selection
	if (x_mouse >= 667 && x_mouse <= (667 + 50) && y_mouse >= 10
			&& y_mouse <= (10 + 35)) {
		draw_button(667, 10, 50, 35, 0xCC6600, "R", 1, SW_Frame);
		draw_button(727, 10, 50, 35, 0xCC6600, "W", 0, SW_Frame);
		draw_button(667, 50, 50, 35, 0xCC6600, "B", 0, SW_Frame);
		draw_button(727, 50, 50, 35, 0xCC6600, "Y", 0, SW_Frame);

		IOWR(COLOR_SELECTOR_BASE, 0, 0);
	} else if (x_mouse >= 727 && x_mouse <= (737 + 50) && y_mouse >= 10
			&& y_mouse <= (10 + 35)) {
		draw_button(667, 10, 50, 35, 0xCC6600, "R", 0, SW_Frame);
		draw_button(727, 10, 50, 35, 0xCC6600, "W", 1, SW_Frame);
		draw_button(667, 50, 50, 35, 0xCC6600, "B", 0, SW_Frame);
		draw_button(727, 50, 50, 35, 0xCC6600, "Y", 0, SW_Frame);

		IOWR(COLOR_SELECTOR_BASE, 0, 1);
	} else if (x_mouse >= 667 && x_mouse <= (667 + 50) && y_mouse >= 50
			&& y_mouse <= (50 + 35)) {
		draw_button(667, 10, 50, 35, 0xCC6600, "R", 0, SW_Frame);
		draw_button(727, 10, 50, 35, 0xCC6600, "W", 0, SW_Frame);
		draw_button(667, 50, 50, 35, 0xCC6600, "B", 1, SW_Frame);
		draw_button(727, 50, 50, 35, 0xCC6600, "Y", 0, SW_Frame);

		IOWR(COLOR_SELECTOR_BASE, 0, 2);
	} else if (x_mouse >= 727 && x_mouse <= (727 + 50) && y_mouse >= 50
			&& y_mouse <= (50 + 35)) {
		draw_button(667, 10, 50, 35, 0xCC6600, "R", 0, SW_Frame);
		draw_button(727, 10, 50, 35, 0xCC6600, "W", 0, SW_Frame);
		draw_button(667, 50, 50, 35, 0xCC6600, "B", 0, SW_Frame);
		draw_button(727, 50, 50, 35, 0xCC6600, "Y", 1, SW_Frame);

		IOWR(COLOR_SELECTOR_BASE, 0, 3);
	}

	// BONUS: selecting the song
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 91
			&& y_mouse <= (91 + 35)) {
		draw_button(667,  91, 120, 35, 0xCC6600, "PREV", 1, SW_Frame); // bonus
		draw_button(667,  128, 120, 35, 0xCC6600, "NEXT", 0, SW_Frame); // bonus
    	...
    	switch_song(song_index);
	} else if (x_mouse >= 667 && x_mouse <= (737 + 120) && y_mouse >= 128
			&& y_mouse <= (128 + 35)) {
		draw_button(667,  91, 120, 35, 0xCC6600, "PREV", 0, SW_Frame); // bonus
		draw_button(667,  128, 120, 35, 0xCC6600, "NEXT", 1, SW_Frame); // bonus
...
void switch_song(int new_song_index) {
    switch (new_song_index) {
        case 0:
            current_song = song_1;
            current_song_size = size_song_1;
            break;
        case 1:
            current_song = song_2;
            current_song_size = size_song_2;
            break;
        case 2:
            current_song = song_3;
            current_song_size = size_song_3;
            break;
        default:
