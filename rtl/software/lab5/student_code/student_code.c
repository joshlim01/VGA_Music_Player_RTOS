...
#endif
{
	...
	if(lfsr_val & 1) {
		IOWR_ALTERA_AVALON_PIO_DATA(DDS_INCREMENT_BASE, 430); // 5 Hz -> (5*2^32)/(50*10^6)+0.5 = 430
	}
	else {
		IOWR_ALTERA_AVALON_PIO_DATA(DDS_INCREMENT_BASE, 86); // 1 Hz -> (1*2^32)/(50*10^6)+0.5 = 86
	}
